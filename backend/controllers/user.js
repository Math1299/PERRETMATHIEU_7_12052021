...
const maskemail = require("maskemail"); //POUR MASKER LES EMAIL DANS LA BD
const User = require("../models/User"); //RECUPERATION DE NOTRE MODEL USER

//MIDDLEWARE POUR ENREGISTRER LES NOUVEAUX UTILISATEURS
...
//MIDDLEWARE POUR LA CONNEXIONS DES UTILISATEURS EXISTANTS
